/**
 * Chart theme — shared Recharts styling tokens.
 *
 * Đồng bộ look với các phần mềm khác của hệ thống Doanh nghiệp A (Ant Design Charts).
 * Dùng cho mọi <BarChart>, <AreaChart>, <LineChart>, <PieChart> trong module này.
 */

// ── Palette (đồng nhất với Navy + Gold system) ──────────────
...
// chiếu module taichinhketoan (roleColors + categoryTypeConfig).
