...
const APPS: App[] = [
  ...
  { key: "dieuhanhbi",     name: "TT Điều hành số",      icon: BarChart3,      color: "#1B3A5C", bg: "#e8eef6", url: "https://pkkq-dieuhanhbi-staging.dft.vn",            external: true  },
  { key: "taichinhketoan", name: "Tài chính KT",         icon: Banknote,       color: "#4c1d95", bg: "#f5f3ff", url: "https://pkkq-taichinhketoan-staging.dft.vn",        external: true  },
  { key: "hopdongnhiemvu", name: "Hợp đồng & NV",        icon: ClipboardList,  color: "#4c1d95", bg: "#f5f3ff", url: "https://pkkq-hopdongnhiemvu-staging.dft.vn",       external: true  },
  { key: "muahang",        name: "Mua hàng",              icon: ShoppingCart,   color: "#0369a1", bg: "#e0f2fe", url: "https://pkkq-muahang-staging.dft.vn",               external: true  },
  { key: "kho",            name: "Kho tàng",              icon: Warehouse,      color: "#0369a1", bg: "#e0f2fe", url: "https://pkkq-kho-staging.dft.vn",                   external: true  },
  { key: "sanxuat",        name: "Sản xuất",              icon: Factory,        color: "#065f46", bg: "#d1fae5", url: "https://pkkq-sanxuat-staging.dft.vn",               external: true  },
  { key: "baotri",         name: "Bảo trì",               icon: Wrench,         color: "#065f46", bg: "#d1fae5", url: "https://pkkq-baotri-staging.dft.vn",                external: true  },
  { key: "suachua",        name: "Sửa chữa",              icon: Hammer,         color: "#065f46", bg: "#d1fae5", url: "https://pkkq-suachua-staging.dft.vn",               external: true  },
  { key: "daitu",          name: "Đại tu",                icon: RefreshCw,      color: "#065f46", bg: "#d1fae5", url: "https://pkkq-daitu-staging.dft.vn",                 external: true  },
  { key: "vongdoi",        name: "Vòng đời & CH",         icon: Network,        color: "#92400e", bg: "#fef3c7", url: "https://pkkq-vongdoi-staging.dft.vn",               external: true  },
  { key: "chatluong",      name: "Chất lượng",            icon: ClipboardCheck, color: "#92400e", bg: "#fef3c7", url: "https://pkkq-chatluong-staging.dft.vn",             external: true  },
  { key: "suco",           name: "Sự cố & CĐ",           icon: AlertOctagon,   color: "#92400e", bg: "#fef3c7", url: "https://pkkq-suco-staging.dft.vn",                  external: true  },
  { key: "thunghiem",      name: "Thử nghiệm",            icon: FlaskConical,   color: "#92400e", bg: "#fef3c7", url: "https://pkkq-thunghiem-staging.dft.vn",             external: true  },
  { key: "doluong",        name: "Đo lường & KĐ",        icon: Scale,          color: "#92400e", bg: "#fef3c7", url: "https://pkkq-doluong-staging.dft.vn",               external: true  },
  { key: "antoan",         name: "An toàn KT",            icon: HardHat,        color: "#92400e", bg: "#fef3c7", url: "https://pkkq-antoan-staging.dft.vn",                external: true  },
  { key: "chatbot",        name: "Chatbot AI",            icon: Bot,            color: "#1B3A5C", bg: "#e8eef6", url: "https://pkkq-chatbot-staging.dft.vn",               external: true  },
  { key: "dms",            name: "Tài liệu DMS",          icon: Files,          color: "#1B3A5C", bg: "#e8eef6", url: "https://pkkq-dms-staging.dft.vn",                   external: true  },
];
