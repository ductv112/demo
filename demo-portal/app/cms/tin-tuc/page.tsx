...
const initialNews: NewsItem[] = [
  {
    ...
    views: 342,
    status: "published",
    image: "/images/Hoinghitongket.jpg",
    sapo: "Ngày 15/3/2026, Nhà máy Z119 đã chính thức đưa vào vận hành Hệ thống Quản lý Sửa chữa Số (DRMS), đánh dấu bước chuyển mình quan trọng trong công cuộc chuyển đổi số của đơn vị.",
    body: "Sau hơn 18 tháng chuẩn bị và triển khai thử nghiệm, ngày 15/03/2026, Nhà máy Z119 đã chính thức tổ chức lễ khai trương và đưa vào vận hành Hệ thống Quản lý Sửa chữa Số (Digital Repair Management System – DRMS).\n\nHệ thống DRMS cho phép các phân xưởng quản lý toàn bộ hồ sơ kỹ thuật từ giai đoạn tiếp nhận đến sửa chữa và nghiệm thu trên một nền tảng thống nhất.\n\nGiám đốc Đại tá Trần Văn Đức đánh giá đây là thành quả của quá trình nỗ lực không ngừng của tập thể cán bộ, kỹ sư Nhà máy trong việc ứng dụng công nghệ cao vào công tác sửa chữa khí tài phòng không.",
    tags: "Công nghệ số, DRMS, Chuyển đổi số",
    isHot: true,
  },
  {
    id: "N002",
    title: "Hội thảo khoa học ứng dụng AI trong sửa chữa khí tài phòng không Việt Nam",
    ...
    views: 218,
    status: "published",
    image: "/images/bangiaothietke.jpg",
    sapo: "Hội thảo quy tụ hơn 40 chuyên gia trong và ngoài nước, tập trung thảo luận về tiềm năng ứng dụng trí tuệ nhân tạo vào các giai đoạn chẩn đoán và sửa chữa khí tài phòng không hiện đại.",
    body: "Ngày 12/03/2026, Nhà máy Z119 tổ chức Hội thảo khoa học với chủ đề \"Ứng dụng trí tuệ nhân tạo trong sửa chữa khí tài phòng không\".\n\nCác tham luận tập trung vào các chủ đề: chẩn đoán lỗi tự động bằng thuật toán học máy, ứng dụng AI trong kiểm tra không phá hủy và phân tích tín hiệu radar.",
    tags: "AI, Trí tuệ nhân tạo, Sửa chữa khí tài",
    isHot: false,
  },
  {
    id: "N003",
    ...
    status: "published",
    image: "/images/bangiaothietke.jpg",
    sapo: "Sau 8 tháng triển khai, Phân xưởng Sửa chữa Radar đã hoàn thành đại tu toàn bộ tổ hợp radar P-18 cho Trung đoàn 291, đáp ứng đúng tiến độ và yêu cầu kỹ thuật đề ra.",
    body: "Phòng Thiết kế 1 vừa hoàn thành và bàn giao toàn bộ tổ hợp radar P-18 sau đại tu cho Hội đồng Nghiệm thu kỹ thuật của Cục Kỹ thuật PK-KQ.\n\nHồ sơ bao gồm biên bản kiểm tra kỹ thuật, kết quả thử nghiệm các khối chức năng và tài liệu nghiệm thu theo tiêu chuẩn kỹ thuật quân sự.",
    tags: "Radar P-18, Trung đoàn 291, PK-KQ",
    isHot: false,
  },
  {
    id: "N004",
        ...
        <div className="space-y-4">
          ...
          <Card>
            <CardContent className="p-4 space-y-2">
              ...
              <Input
                placeholder="AI, Công nghệ số, Phòng không..."
                value={draft.tags}
