...
export const navMenu = [
  ...
  },
  {
    ...
    href: "/he-thong",
    children: [
      { label: "Tài chính Kế toán", href: "http://localhost:5175" },
      { label: "Quản lý Mua hàng", href: "http://localhost:5177" },
      { label: "Hợp đồng & Nhiệm vụ", href: "http://localhost:5176" },
      { label: "Quản lý Kho tàng", href: "http://localhost:5178" },
      { label: "Quản lý Sản xuất", href: "http://localhost:5179" },
      { label: "Quản lý Bảo trì", href: "http://localhost:5180" },
      { label: "Quản lý Sửa chữa", href: "http://localhost:5181" },
...
export const portalEvents: PortalEvent[] = [
  {
    ...
    image: "https://images.unsplash.com/photo-1573496359142-e8d3398dc6c8?w=1200&q=80&auto=format&fit=crop",
    category: "Sự kiện",
    date: "07/08/2025",
...
export const featuredNews = {
  ...
  category: "Sự kiện",
  date: "07/08/2025",
  image: "https://images.unsplash.com/photo-1559223607-a43c990c692c?w=1200&q=80&auto=format&fit=crop",
};
