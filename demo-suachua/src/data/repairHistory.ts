...
export const repairHistory: RepairHistoryRecord[] = [
  {
    id: 'RH001', equipmentId: 'EQ-RDR-001', equipmentName: 'Hệ thống monitoring P-18', equipmentType: 'radar',
  ...
  {
    id: 'RH002', equipmentId: 'EQ-COM-001', equipmentName: 'Thiết bị truyền dữ liệu liên kết', equipmentType: 'communication',
  ...
  {
    id: 'RH003', equipmentId: 'EQ-RDR-001', equipmentName: 'Hệ thống monitoring P-18', equipmentType: 'radar',
  ...
  {
    id: 'RH004', equipmentId: 'EQ-RDR-002', equipmentName: 'Hệ thống monitoring 36D6', equipmentType: 'radar',
  ...
  {
    id: 'RH005', equipmentId: 'EQ-MSL-001', equipmentName: 'Module S-125 Pechora', equipmentType: 'missile',
  ...
  {
    id: 'RH006', equipmentId: 'EQ-RDR-003', equipmentName: 'Hệ thống monitoring P-37', equipmentType: 'radar',
