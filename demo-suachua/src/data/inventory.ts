...
export const inventory: InventoryItem[] = [
  ...
  { id: 'INV008', code: 'LK-PSU-P37', name: 'Mô-đun nguồn chính P-37', unit: 'cái', stock: 0, unitPrice: 120, category: 'module', location: 'Đặt hàng Trung tâm phần mềm Alpha' },
  ...
  { id: 'INV011', code: 'LK-DSP-S300', name: 'Module DSP xử lý chính S-300', unit: 'cái', stock: 1, unitPrice: 150, category: 'module', location: 'Kho B - Kệ M03' },
  ...
  { id: 'INV022', code: 'LK-MOD-RF36', name: 'Mô-đun RF Hệ thống monitoring 36D6', unit: 'cái', stock: 1, unitPrice: 95, category: 'module', location: 'Kho A - Kệ R05' },
];
