...
export const budgetRegistrations2027: BudgetRegistration[] = [
  {
    ...
    justification: 'BT 3 hệ thống monitoring: P-18 (TT 291), 36D6 (Khối K01), P-37 (Khối K03). Dự kiến phát sinh thêm 1 hệ thống từ Tổng công ty.',
  ...
  },
  {
    ...
    justification: 'Tiếp tục NC phương pháp kiểm tra mạch vi xử lý GĐ2 + đề tài mới về phục hồi board mạch.',
  ...
  },
  {
    ...
    justification: 'BT sản phẩm chủ lực S-125 (TT 285), SA-3, dự kiến thêm 1 sản phẩm S-75 từ đơn vị.',
  ...
  },
  {
    ...
    justification: 'Nâng cấp lớn sản phẩm S-75 GĐ2 + dự kiến nâng cấp bổ sung 1 sản phẩm SA-3.',
  ...
  },
  {
    ...
    justification: 'BT hệ thống truyền thông nội bộ cho Khối K07 + Khối K01.',
  ...
  },
  {
    ...
    justification: 'BT cơ cấu cơ khí cho các hệ thống monitoring và module triển khai theo kế hoạch 2027.',
  ...
  },
  {
    ...
    justification: 'NC nâng cấp phần mềm hệ thống monitoring số GĐ2 + đề xuất NC quy trình kiểm tra không phá hủy.',
  ...
  },
  {
    ...
    justification: 'Chi phí hành chính logistics năm 2027: văn phòng phẩm, xăng dầu, bảo trì văn phòng.',
  ...
  },
  {
    ...
    justification: 'Đào tạo nâng cao: kỹ thuật hệ thống monitoring thế hệ mới, thiết bị ATE, an toàn bức xạ.',
  ...
  },
  {
    ...
    justification: 'Xây dựng quy trình nâng cấp lớn cho hệ thống monitoring thế hệ mới triển khai năm 2027.',
  ...
  },
  {
    ...
    justification: 'Chi phí hoạt động truyền thông nội bộ năm 2027.',
  ...
  },
  {
    ...
    justification: 'Nâng cấp lớn 2 hệ thống monitoring P-37 và P-18 theo kế hoạch năm 2027.',
