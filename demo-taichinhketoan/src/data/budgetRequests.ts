...
export const budgetRequests2027: BudgetRequest[] = [
  {
    ...
    taskName: 'BT Hệ thống monitoring P-18 và 36D6 năm 2027', description: 'Bảo trì các hệ thống monitoring cảnh báo theo kế hoạch năm 2027',
    ...
    items: [
      ...
      { id: 'BRI-002', name: 'Nhân công bảo trì', amount: 2000 },
      { id: 'BRI-003', name: 'Thuê thiết bị đo, kiểm', amount: 1200 },
      { id: 'BRI-004', name: 'Thuê chuyên gia', amount: 700 },
      { id: 'BRI-005', name: 'Logistics thiết bị', amount: 400 },
    ],
  },
  {
    id: 'BR-002', costPlanId: 'KHCP-2027', departmentId: 'PX1', taskType: 'research',
    taskName: 'NC Hệ thống monitoring P-37 năm 2027', description: 'Nâng cấp lớn hệ thống monitoring dẫn đường P-37 theo kế hoạch năm 2027',
    ...
    items: [
      { id: 'BRI-006', name: 'Vật tư, phụ tùng nâng cấp', amount: 2800 },
      { id: 'BRI-007', name: 'Nhân công nâng cấp', amount: 1800 },
  ...
  },
  {
    ...
    taskName: 'BT Sản phẩm chủ lực S-125 và SA-3 năm 2027', description: 'Bảo trì sản phẩm chủ lực vận hành hệ thống theo kế hoạch',
    ...
    items: [
      { id: 'BRI-010', name: 'Vật tư, linh kiện module triển khai', amount: 3500 },
      { id: 'BRI-011', name: 'Nhân công bảo trì', amount: 2500 },
      { id: 'BRI-012', name: 'Hệ thống thủy lực', amount: 1800 },
      { id: 'BRI-013', name: 'Thử nghiệm hệ thống điều phối', amount: 1200 },
    ],
  },
  {
    id: 'BR-004', costPlanId: 'KHCP-2027', departmentId: 'PKT', taskType: 'research',
    taskName: 'NC nâng cấp phần mềm hệ thống monitoring số GĐ2', description: 'Tiếp tục nghiên cứu nâng cấp phần mềm xử lý tín hiệu hệ thống monitoring',
  ...
  },
  {
    ...
    taskName: 'BT Hệ thống truyền thông nội bộ năm 2027', description: 'Bảo trì hệ thống truyền thông nội bộ cho các Khối',
    ...
    items: [
      ...
      { id: 'BRI-019', name: 'Nhân công bảo trì', amount: 1500 },
      { id: 'BRI-020', name: 'Thử nghiệm tích hợp', amount: 1300 },
    ],
  },
  {
    id: 'BR-006', costPlanId: 'KHCP-2027', departmentId: 'PHCKT', taskType: 'admin',
    taskName: 'Chi phí hành chính logistics năm 2027', description: 'Dự toán chi phí văn phòng, xăng dầu, bảo trì văn phòng năm 2027',
    ...
    items: [
      ...
      { id: 'BRI-023', name: 'Sửa chữa, bảo trì văn phòng', amount: 1900 },
    ],
  },
  {
    id: 'BR-007', costPlanId: 'KHCP-2027', departmentId: 'PKH', taskType: 'training',
    taskName: 'Chương trình đào tạo năm 2027', description: 'Đào tạo nâng cao năng lực kỹ thuật cho cán bộ, nhân viên Doanh nghiệp A',
    ...
    items: [
      { id: 'BRI-024', name: 'Đào tạo kỹ thuật hệ thống monitoring thế hệ mới', amount: 1000 },
