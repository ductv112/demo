...
export const departments: Department[] = [
  ...
  { id: 'PCT', name: 'Phòng Nhân sự', shortName: 'P.NS', type: 'admin', head: 'Trần Đức Mạnh' },
  ...
  { id: 'PHCKT', name: 'Phòng Logistics - Kỹ thuật', shortName: 'P.LGKT', type: 'admin', head: 'Lê Văn Toàn' },
  ...
  { id: 'PX2', name: 'Trung tâm Module CRM', shortName: 'PX2', type: 'technical', head: 'Bùi Minh Trí' },
  { id: 'PX3', name: 'Trung tâm Hạ tầng', shortName: 'PX3', type: 'technical', head: 'Lý Hoàng Nam' },
  { id: 'PX4', name: 'Trung tâm Phần mềm', shortName: 'PX4', type: 'technical', head: 'Trần Anh Dũng' },
];
