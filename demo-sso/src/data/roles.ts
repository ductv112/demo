...
export const roles: Role[] = [
  { id: 'R01', name: 'Giám đốc', code: 'DIRECTOR', description: 'Giám đốc / Phó Giám đốc nhà máy — toàn quyền trên mọi phần mềm', level: 1, userCount: 3, color: '#ff4d4f' },
  { id: 'R02', name: 'Trưởng phòng', code: 'HEAD', description: 'Trưởng phòng / Quản đốc — quản lý nghiệp vụ thuộc phòng ban', level: 2, userCount: 7, color: '#D4A843' },
  ...
  { id: 'R05', name: 'Kỹ thuật viên', code: 'TECHNICIAN', description: 'Kỹ thuật viên phân xưởng — nhập liệu, báo cáo kỹ thuật', level: 5, userCount: 8, color: '#722ed1' },
