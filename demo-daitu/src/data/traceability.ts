...
export const traceabilityRecords: TraceabilityRecord[] = [
  // ─── TRC-001: WO-001 P-37 — Hoàn thành toàn bộ 6 bước ──────────────────────
  {
    ...
    equipmentName: 'Hệ thống monitoring P-37 (P37-291-001)',
    status: 'completed',
    // Bước 1
    ...
    completedItems: [
      ...
      'Nghiệm thu và bàn giao Phòng P291',
    ],
    responsiblePerson: 'Nguyễn Văn Hải — Phó giám đốc Phòng Kỹ thuật',
    supervisorName: 'Phạm Quốc Hưng — Giám đốc Trung tâm phần mềm Alpha',
    ...
    technicalChangeItems: [
      { type: 'standard', description: 'Áp dụng TCQS-2025-MON về độ rung và chấn động', reference: 'TCQS-2025-MON', appliedDate: '2025-12-01' },
    ...
    technicalChanges: [
      'Áp dụng TCQS-2025-MON về độ rung',
      'Cải tiến hệ thống làm mát (BK-2024-015)',
    ],
    // Bước 5
    componentTraceItems: [
      { componentId: 'CMP-001-01', componentName: 'Ống dẫn sóng chính', action: 'replace', serialNo: 'WG-2025-001', supplier: 'Đối tác CNC Hà Nội', installDate: '2025-12-05', lifeRemaining: '10 năm' },
      { componentId: 'CMP-001-02', componentName: 'Vòng bi trục anten (×4)', action: 'replace', serialNo: 'BRG-SKF-2025', supplier: 'Đối tác công nghiệp Hà Nội', installDate: '2025-12-07', lifeRemaining: '8 năm' },
      { componentId: 'CMP-001-03', componentName: 'Tụ điện tần số cao (×8)', action: 'replace', serialNo: 'CAP-HF-2025', supplier: 'Đối tác Điện tử Z11', installDate: '2025-12-08' },
      { componentId: 'CMP-001-04', componentName: 'Bộ hiển thị monitoring', action: 'upgrade', serialNo: 'DSP-LED-001', supplier: 'Công ty Điện tử Hà Nội', installDate: '2025-12-10', lifeRemaining: '15 năm' },
      { componentId: 'CMP-001-05', componentName: 'Bộ gioăng làm kín (bộ)', action: 'replace', supplier: 'Trung tâm phần mềm Alpha tự sản xuất', installDate: '2025-12-06' },
    ...
    syncedAt: '2025-12-27',
    notes: 'Hồ sơ truy vết hoàn thành. Thiết bị bàn giao Phòng P291 ngày 25/12/2025. Lệnh đại tu WO-001 đã đóng.',
  },
  ...
  // ─── TRC-002: WO-005 S-75 — Bước 6: Đang đồng bộ ────────────────────────────
  {
    ...
    equipmentName: 'Module S-75 Dvina (S75-361-003)',
    status: 'syncing',
    // Bước 1
    ...
    completedItems: [
      ...
      'Đại tu hệ thống dẫn đường monitoring',
      ...
      'Nghiệm thu Phạm Quốc Hưng ngày 05/04/2026',
    ],
    responsiblePerson: 'Trần Đức Mạnh — Trưởng phòng TT Beta',
    supervisorName: 'Phạm Quốc Hưng — Giám đốc Trung tâm phần mềm Alpha',
    ...
    // Bước 5
    componentTraceItems: [
      { componentId: 'CMP-005-01', componentName: 'Module dẫn đường monitoring', action: 'restore', installDate: '2026-03-10', lifeRemaining: '8 năm' },
      { componentId: 'CMP-005-02', componentName: 'Bơm thủy lực cơ cấu phóng', action: 'replace', serialNo: 'HYD-2026-015', supplier: 'Bosch Rexroth (qua đại lý)', installDate: '2026-03-12', lifeRemaining: '12 năm' },
      ...
      { componentId: 'CMP-005-04', componentName: 'Cụm encoder góc phương vị', action: 'replace', serialNo: 'ENC-ABS-2026', supplier: 'Đối tác Điện tử Z11', installDate: '2026-03-16', lifeRemaining: '10 năm' },
  ...
  // ─── TRC-003: WO-004 S-125 — Bước 5: Đang thiết lập truy vết ────────────────
  {
    ...
    equipmentName: 'Module S-125 Pechora (S125-363-002)',
    status: 'tracing',
    // Bước 1
    ...
    componentTraceItems: [
      { componentId: 'CMP-004-01', componentName: 'Xy-lanh thủy lực nâng chính', action: 'replace', serialNo: 'CYL-HYD-2026-04', supplier: 'Đối tác CNC Hà Nội', installDate: '2026-03-05', lifeRemaining: '12 năm' },
      { componentId: 'CMP-004-02', componentName: 'Bơm thủy lực chính', action: 'replace', serialNo: 'PMP-HYD-2026-04', supplier: 'Bosch Rexroth (qua đại lý)', installDate: '2026-03-06', lifeRemaining: '10 năm' },
      { componentId: 'CMP-004-03', componentName: 'Encoder góc nâng hạ', action: 'replace', serialNo: 'ENC-2026-S125', supplier: 'Đối tác Điện tử Z11', installDate: '2026-03-08' },
    ],
  ...
  // ─── TRC-004: WO-003 P-18 — Bước 3: Cập nhật cấu hình ────────────────────────
  {
    ...
    equipmentName: 'Hệ thống monitoring P-18 (P18-367-001)',
    status: 'configuring',
    // Bước 1
  ...
  // ─── TRC-005: WO-002 36D6 — Bước 1: Đang tổng hợp dữ liệu ──────────────────
  {
    ...
    equipmentName: 'Hệ thống monitoring 36D6 (36D6-361-001)',
    status: 'collecting',
    ...
    responsiblePerson: 'KS. Nguyễn Thanh Sơn — TT Alpha',
    supervisorName: 'Nguyễn Văn Hải',
